...
## Project Structure
    ...
    ├── testapiautoteammemb_68965  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_68965`
...
2. Clone this repo and `cd testapiautoteammemb_68965`
